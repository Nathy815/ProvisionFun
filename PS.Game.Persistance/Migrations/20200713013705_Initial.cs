    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("66300219-e7f6-4f17-a859-d8cc11315796"), true, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "Administrador" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Active", "CreatedDate", "ModifiedDate", "Name" },
                values: new object[] { new Guid("2f743547-6ab3-4f99-93a0-457eab81fecf"), true, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "Auditor" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Active", "CreatedDate", "Email", "IsMaster", "ModifiedDate", "Name", "Password", "RoleID" },
                values: new object[] { new Guid("0f054b3e-aaf0-44ae-a2af-4d1f1fa69b02"), true, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "master@master.com", true, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "Master", "master123", new Guid("66300219-e7f6-4f17-a859-d8cc11315796") });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Active", "CreatedDate", "Email", "IsMaster", "ModifiedDate", "Name", "Password", "RoleID" },
                values: new object[] { new Guid("d06fc2b3-d60b-4ad2-8794-829daa444506"), true, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "adm@adm.com", false, new DateTime(2020, 7, 4, 13, 55, 0, 0, DateTimeKind.Unspecified), "Administrator", "admin123", new Guid("66300219-e7f6-4f17-a859-d8cc11315796") });
