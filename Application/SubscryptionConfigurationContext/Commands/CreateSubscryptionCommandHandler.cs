...
namespace Application.SubscryptionConfigurationContext.Commands
{
        ...
        public async Task<bool> Handle(CreateSubscryptionCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var _team = new Team
                {
                    ...
                    Price = _tournament.StartSubscryption.AddDays(15) <= DateTime.Now.Date ? 20D : 30D
                };
                ...
                _team.Players.Add(new TeamPlayer
                {
                    Id = Guid.NewGuid(),
                    IsPrincipal = true,
                    PlayerID = _player.Id,
