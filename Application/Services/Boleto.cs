...
{
    public class Boleto : Util, IBoleto
    {
        ...
        public Boleto(IGeneratePdf generatePdf, MySqlContext sqlContext, IEmail email)
        {
        ...
        public async Task<string> GenerateShipping(List<Team> teams, string virtualPath)
        {
            try
            {
                ...
                var _fileName = GetFileName("Remessa");
        ...
        public async Task<bool> ImportReturn(IFormFile file, string virtualPath)
        {
            try
            {
                var _fileName = GetFileName("Retorno");
                var _file = UploadFile(file, _fileName, virtualPath);
